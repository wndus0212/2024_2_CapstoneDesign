    ...
    methods: {
      async fetchFinancialState() {
        try {
            ...
            axios
                .get(`https://web-capstonedesignfront-m3vkxnzga0885b97.sel4.cloudtype.app/stock/financial_state/income_stmt/${this.stockCode}/`)
                .then(response => {
            ...
            axios
                .get(`https://web-capstonedesignfront-m3vkxnzga0885b97.sel4.cloudtype.app/stock/financial_state/balance_sheet/${this.stockCode}/`)
                .then(response => {
            ...
            axios
                .get(`https://web-capstonedesignfront-m3vkxnzga0885b97.sel4.cloudtype.app/stock/financial_state/cashflow/${this.stockCode}/`)
                .then(response => {
